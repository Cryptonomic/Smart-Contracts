...
var tezosNode = 'http://alphanet-node.tzscan.io:80';
function invokeContract() {
    return __awaiter(this, void 0, void 0, function () {
        var keystore, contractAddress, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    contractAddress = 'KT1KA7DqFjShLC4CPtChPX8QtRYECUb99xMY';
                    return [4 /*yield*/, conseiljs_1.TezosNodeWriter.sendContractInvocationOperation(tezosNode, keystore, contractAddress, 10000, 100000, '', 1000, 100000, '"Cryptonomicon"')];
                case 1:
                    result = _a.sent();
