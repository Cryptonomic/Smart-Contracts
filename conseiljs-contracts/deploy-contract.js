...
function deployContract() {
    return __awaiter(this, void 0, void 0, function () {
        var keystore, contract, storage, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    storage = 'Sample';
                    return [4 /*yield*/, conseiljs_1.TezosNodeWriter.sendContractOriginationOperation(tezosNode, keystore, 10000, undefined, true, true, 100000, '', '10000', '10000', contract, storage)];
                case 1:
                    result = _a.sent();
