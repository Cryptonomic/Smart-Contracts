# Cryptonomic risk-free bond financial instrument
# FA1.2 interface inspired by 

import smartpy as sp

def Instrument(sp.Contract):
	...
	def __init__(self, discountSchedule, discountSchedule, expiration, periodLength, baker):
		# type constraints
		self.init(
