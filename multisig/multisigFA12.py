...
class MultiSigWallet(FA12Interface.MultiSigWalletInterface):
    ...
    def executeAdminSwitch(self, id):
        sp.set_type(id, sp.TNat)
        make_switch = sp.contract(sp.TAddress, self.data.transferMap[id].tokenAddress, "setAdministrator").open_some()
    ...
    def recoverToken(self, params):
        sp.set_type(params, FA12Interface.INIT_RECOVER_TYPE)
    ...
    def addAdminSwitch(self, params):
        sp.set_type(params, FA12Interface.ADMIN_TYPE)
